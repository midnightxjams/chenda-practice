    ...
    sections: [
      {
        ...
        repeatCount: 2,
        treblePattern: ``,
        bassPattern: `THA REST4 REST4 REST2
THAKAA THAKAA REST1
THA REST1 THA REST1 THA REST1
THAKAA REST2 REST4 REST2 REST0.5
THAKAA THAKAA REST1
THA REST1 THA REST1 THA REST1
THA REST1 REST4 REST4 REST1
THAKAA THAKAA REST1
THA REST1 THA REST1 THA REST1
THAKAA REST2 REST4 REST2 REST0.5
THAKAA THAKAA REST1
THA REST1 THA REST1 THA
THAKKA THAKAA REST0.5 REST1
THAKAA THAKAA REST1
THAKKA THAKAA REST0.5 REST1
THAKAA THAKAA REST1
THAKKA THAKAA REST0.5 REST1
...
THAKAA THAKAA REST1`,
        transitionAfter: {
          treblePattern: ``,
          bassPattern: `THAKAA REST1 THAKAA REST1 THAKAA REST1 THAKAA REST1
REST2`
        }
      },
      {
        ...
        repeatCount: 4,
        treblePattern: ``,
        bassPattern: `THAKAA REST1 THAKAA
THA REST2 THAKAA REST0.5
THA REST2 THAKAA REST0.5
THAKKA THAKA REST2`,
        transitionAfter: {
          treblePattern: ``,
...
REST2`
      ...
      },
      {
        ...
        repeatCount: 4,
        treblePattern: ``,
        bassPattern: `THA REST1 THA REST1 THA REST1
THAKAA REST1 THAKAA
THAKAA REST1 THAKAA
THA REST1 THA REST1 THA REST1`,
        transitionAfter: {
...
THAKKA REST2 THA REST1 THA REST2 THA REST2
THAKKA THAKAA REST1 THAKKA THAKAA REST1
THA REST1 THA REST1 THA REST1 THA REST0.5 THA REST0.5 THA REST2`,
        transitionAfter: {
          treblePattern: ``,
          bassPattern: `THAKAA REST1 THAKAA REST1 THAKAA REST1 THAKAA REST1
REST2`
...
THA THA REST1 THA THA REST1
THA REST1 REST0.5 THA REST1 REST0.5 THA REST1 REST0.5
THA THA REST1 THA THA REST1
THA REST1 REST0.5 THA REST1 REST0.5 THA REST1 REST0.5 THA REST4
THA REST1 REST0.5 THA REST1 REST0.5 THA REST1 REST0.5 THA REST4`,
        transitionAfter: {
          treblePattern: ``,
          bassPattern: `THAKAA REST1 THAKAA REST1 THAKAA REST1 THAKAA REST1
...
THA REST1 THA REST1 THA REST1 THA REST1 THA REST1 THA REST1 REST0.5
THAKAA THAKAA REST1
THA REST1 THA REST1 THA REST1 THA REST1 THA REST1 THA REST1 REST0.5
THAKKA THAKAA REST1
THA REST1 THA REST1 THA REST1 THA REST1 THA REST1 THA REST1 REST0.5
...
THAKAA THAKAA REST1
THA REST1 THA REST1
THAKKA THAKAA REST1 THAKAA THAKAA REST0.5
THAKKA THAKAA REST1 THAKAA THAKAA REST0.5
THAKKA THAKAA REST1 THAKAA THAKAA REST0.5
THAKKA THAKAA REST1 THAKAA THAKAA REST0.5
THA REST1 THA REST1 THA REST1 THA REST1 THA REST1 THA REST1
THA REST0.5 THA REST0.5 THA REST1
THA REST1 THA REST1 THA REST1 THA REST1 THA REST1 THA REST1
THA REST0.5 THA REST0.5 THA REST1
THA REST1 THA REST1 THA REST1 THA REST1 THA REST1 THA REST1
THA REST0.5 THA REST0.5 THA REST1
...
function localSongs() {
  const builtInIds = new Set(builtInSongs().map(song => song.id));
  return readSongLibrary().filter(song => !builtInIds.has(song.id)).sort((a, b) => a.name.localeCompare(b.name));
}
function allSongs() { return [...builtInSongs(), ...localSongs()]; }
function builtInValidationErrors() {
  const errors = [];
  BUILT_IN_SONGS.forEach(song => {
...
function reportBuiltInValidation() {
  const errors = builtInValidationErrors();
  if (errors.length) console.warn("Built-in song validation errors:\n" + errors.join("\n"));
}
...
function renderPracticeRanges() {
  ...
  currentSong.sections.forEach((_, index) => {
    ...
    option.textContent = currentSong.sections[index]?.name || "Section " + (index + 1);
  ...
  if (practiceRangeKind() === "transition") {
    ...
    transition.value = selectedPracticeRange;
    transition.textContent = transitionLabel(selectedTransitionIndex());
